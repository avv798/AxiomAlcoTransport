...
{
	public partial class TicketForm : XtraForm
	{
        ...
        public TicketForm(Documents documents): this()
        {
            try
            {
        ...
        private void TicketForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Document_bindingSource.DataSource = documents.Tickets;
        ...
        private void TicketForm_Activated(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = MdiParent.Cursor = Cursors.WaitCursor;
                MainRibbonControl.SelectedPage = Ticket_ribbonPage;
        ...
        private void Document_gridView_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            try
            {
                ...
                Ticket current = (Ticket)Document_gridView.GetRow(e.RowHandle);
        ...
        private void Document_gridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                Ticket selected = (Ticket)Document_bindingSource.Current;
	    ...
	    private void changeDocumentReadingStatus(bool status)
	    {
            try
            {
                ...
                {
                    Ticket p = (Ticket)Document_gridView.GetRow(i);
