...
{
	public partial class RestsForm : XtraForm
	{
        ...
        public RestsForm(Documents documents): this()
        {
            try
            {
        ...
        private void RestsForm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void RestsForm_Activated(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = MdiParent.Cursor = Cursors.WaitCursor;
                MainRibbonControl.SelectedPage = Rests_ribbonPage;
        ...
        private void RestsForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void RequestRestss_barButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            sendRequest();
        }
        ...
        private void Document_gridView_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            try
            {
                ...
                ARests current = (ARests)Document_gridView.GetRow(e.RowHandle);
        ...
        private void Document_gridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                ARests selected = (ARests)Document_bindingSource.Current;
        ...
        private void RestsPositions_barButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            showPosition();
        }
	    ...
	    private void changeDocumentReadingStatus(bool status)
	    {
            try
            {
                ...
                {
                    ARests p = (ARests)Document_gridView.GetRow(i);
        ...
        private void showPosition()
        {
            try
            {
                ...
                (new RestsPositionViewForm(selected, documents, (selected is Rests))).ShowDialog();
            }
            catch (Exception exception)
            {
                Program.Logger.Error("Во время выполнения операции произошла ошибка.", exception);
