...
{
    public partial class ActChargeOnShopEditorForm : XtraForm
    {
        ...
        /// Только чтение.
        /// </summary>
        private readonly ActChargeOnShop act;
        /// <summary>
        ...
        /// </summary>
        public ActChargeOnShopEditorForm()
        {
            try
            {
        ...
        public ActChargeOnShopEditorForm(Documents documents, ActChargeOnShop act) : this()
        {
            try
            {
        ...
        private void ActChargeOnShopEditorForm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void ActChargeOnShopEditorForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (dataChanged)
        ...
        private void ActChargeOnShopEditorForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void setControlsEnable()
        {
            ...
            else
            {
                ...
                Text = "Просмотр акта постановки товара на баланс в товарном зале организации";
            }
        }
        /// <summary>
        /// Добавить позицию.
        ...
        private void addPosition()
        {
            try
            {
                ...
                if (positions.Any(MovePosition => (MovePosition.AlcoCode == selected.AlcCode)))
                {
                ...
                positions.Add(new MovePosition(MovementType.ActChargeOnShop, selected));
