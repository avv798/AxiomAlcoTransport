...
{
    public partial class ActChargeOffEditorForm : XtraForm
    {
        ...
        /// Только чтение.
        /// </summary>
        private readonly ActChargeOff act;
        /// <summary>
        ...
        public ActChargeOffEditorForm(Documents documents, ActChargeOff act) : this()
        {
            try
            {
        ...
        private void ActChargeOffEditorForm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void ActChargeOffEditorForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (dataChanged)
        ...
        private void ActChargeOffEditorForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void deleteItemButtonEdit_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (Position_bindingSource.Current == null) return;
            MainForm.InLogErrorContext(() =>
            {
        ...
        private void setControlsEnable()
        {
            ...
            else
            {
                ...
                Text = "Просмотр акта списания товара со склада организации";
            }
        }
        /// <summary>
        /// Добавить позицию.
