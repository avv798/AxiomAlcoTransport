...
{
    public partial class ActChargeOffShopEditorForm : XtraForm
    {
        ...
        /// Только чтение.
        /// </summary>
        private readonly ActChargeOffShop act;
        /// <summary>
        ...
        /// </summary>
        public ActChargeOffShopEditorForm()
        {
            try
            {
        ...
        public ActChargeOffShopEditorForm(Documents documents, ActChargeOffShop act) : this()
        {
            try
            {
        ...
        private void ActChargeOffShopEditorForm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void ActChargeOffShopEditorForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (dataChanged)
        ...
        private void ActChargeOffShopEditorForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void setControlsEnable()
        {
            ...
            else
            {
                ...
                Text = "Просмотр акта списания товара из товарного зала организации";
            }
        }
        /// <summary>
        /// Добавить позицию.
        ...
        private void addPosition()
        {
            try
            {
                ...
                if (positions.Any(MovePosition => (MovePosition.AlcoCode == selected.AlcoCode)))
                {
                ...
                positions.Add(new MovePosition(MovementType.ActChargeOffShop, selected));
