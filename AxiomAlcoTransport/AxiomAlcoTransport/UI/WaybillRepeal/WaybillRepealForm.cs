...
{
	public partial class WaybillRepealForm : XtraForm
	{
        ...
        public WaybillRepealForm(Documents documents): this()
        {
            try
            {
        ...
        private void WaybillRepealForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Document_bindingSource.DataSource = documents.WaybillRepeals;
        ...
        private void WaybillRepealForm_Activated(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = MdiParent.Cursor = Cursors.WaitCursor;
                MainRibbonControl.SelectedPage = WaybillRepeal_ribbonPage;
        ...
        private void WaybillRepealForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void Document_gridView_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            try
            {
                ...
                WaybillRepeal current = (WaybillRepeal)Document_gridView.GetRow(e.RowHandle);
        ...
        private void Document_gridView_SelectionChanged(object sender, DevExpress.Data.SelectionChangedEventArgs e)
        {
            try
            {
                ...
                WaybillRepeal selected = (WaybillRepeal)Document_bindingSource.Current;
	    ...
	    private void changeDocumentReadingStatus(bool status)
	    {
            try
            {
                ...
                {
                    WaybillRepeal p = (WaybillRepeal)Document_gridView.GetRow(i);
	    ...
	    private void actHandler(bool isAccepted)
	    {
            try
            {
                ...
                if (selected.StatusEnum == WaybillRepealStatus.New)
                {
                    (new WaybillRepealSingleForm(documents, selected, isAccepted)).ShowDialog();
                ...
                {
                    XtraMessageBox.Show("Подтвердить или отказать можно только запрос на распроведение, находящийся в статусе \"Новый\"",
