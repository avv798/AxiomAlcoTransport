...
namespace Axiom.AlcoTransport
{
	public partial class MainForm
	{
        ...
        /// </summary>
        public void ShowWaybillRepealForm()
        {
		...
		/// Создать и показать форму.
		/// </summary>
		protected void showWaybillRepealForm()
		{
			try
			{
                SplashAccessor.Show();
				...
				{
					if (!(child is WaybillRepealForm)) continue;
                ...
                WaybillRepealForm form = new WaybillRepealForm(documents)
                                            {
                                                MdiParent = this,
