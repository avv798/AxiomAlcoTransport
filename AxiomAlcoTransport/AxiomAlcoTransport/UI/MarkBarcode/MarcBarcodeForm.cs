...
{
	public partial class MarkBarcodeForm : XtraForm
	{
        ...
        public MarkBarcodeForm(Documents documents): this()
        {
            try
            {
        ...
        private void MarkBarcodeForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Document_bindingSource.DataSource = documents.MarkBarcodes;
        ...
        private void MarkBarcodeForm_Activated(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = MdiParent.Cursor = Cursors.WaitCursor;
                MainRibbonControl.SelectedPage = MarkBarcode_ribbonPage;
        ...
        private void MarkBarcodeForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void RequestMarkBarcodes_barButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                using (MarksRequestForm form = new MarksRequestForm(documents))
                {
                    ...
                    documents.RequestMarkBarcode(form.Marks);

                    SplashAccessor.Close();
                    Cursor = Cursors.Default;

                    XtraMessageBox.Show("Запрос на получение штрих-кодов успешно отправлен.",
                                        "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception exception)
            {
                const string msg = "Во время отправки запроса на получение штрих-кодов произошла ошибка.";
        ...
        private void Document_gridView_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            try
            {
                ...
                MarkBarcode current = (MarkBarcode)Document_gridView.GetRow(e.RowHandle);
        ...
        private void Document_gridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                MarkBarcode selected = (MarkBarcode)Document_bindingSource.Current;
	    ...
	    private void changeDocumentReadingStatus(bool status)
	    {
            try
            {
                ...
                {
                    MarkBarcode p = (MarkBarcode)Document_gridView.GetRow(i);
