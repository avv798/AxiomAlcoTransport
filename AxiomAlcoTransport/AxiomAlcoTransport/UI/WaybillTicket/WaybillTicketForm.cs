...
{
	public partial class WaybillTicketForm : XtraForm
	{
        ...
        public WaybillTicketForm(Documents documents): this()
        {
            try
            {
        ...
        private void WaybillTicketForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Document_bindingSource.DataSource = documents.WaybillTickets;

                WaybillTicket_ribbonPage.Text = Text;
        ...
        private void WaybillTicketForm_Activated(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = MdiParent.Cursor = Cursors.WaitCursor;
                MainRibbonControl.SelectedPage = WaybillTicket_ribbonPage;
        ...
        private void WaybillTicketForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void Document_gridView_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            try
            {
                ...
                WaybillTicket current = (WaybillTicket)Document_gridView.GetRow(e.RowHandle);
        ...
        private void Document_gridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                WaybillTicket selected = (WaybillTicket)Document_bindingSource.Current;
	    ...
	    private void changeDocumentReadingStatus(bool status)
	    {
            try
            {
                ...
                {
                    WaybillTicket p = (WaybillTicket)Document_gridView.GetRow(i);
