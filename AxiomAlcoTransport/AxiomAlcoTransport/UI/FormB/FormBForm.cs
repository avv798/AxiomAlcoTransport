...
{
	public partial class FormBForm : XtraForm
	{
        ...
        public FormBForm(Documents documents): this()
        {
            try
            {
        ...
        private void FormBForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Document_bindingSource.DataSource = documents.FormBList;
        ...
        private void FormBForm_Activated(object sender, EventArgs e)
        {
            try
            {
                ...
                Cursor = MdiParent.Cursor = Cursors.WaitCursor;
                MainRibbonControl.SelectedPage = FormB_ribbonPage;
        ...
        private void FormBForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void RequestFormBs_barButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                                                                                     ...
                                                                                     "получить справку формы 'Б'..."))
                {
                    ...
                    documents.RequestForm(FormsFormat.B, form.Position.FormBRegId);

                    XtraMessageBox.Show("Запрос на получение справки формы 'Б' успешно отправлен.",
                                        "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception exception)
            {
                const string msg = "Во время отправки запроса на получение справки формы 'Б' произошла ошибка.";
        ...
        private void Document_gridView_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e)
        {
            try
            {
                ...
                FormB current = (FormB)Document_gridView.GetRow(e.RowHandle);
        ...
        private void Document_gridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                FormB selected = (FormB)Document_bindingSource.Current;
        ...
        private void Garbage_barButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                List<FormB> selected = Document_gridView.GetSelectedRows().Select(i => (FormB)Document_gridView.GetRow(i)).ToList();
                                                                          ...
                                                                          , MessageBoxIcon.Question))
                {
                    ...
                    foreach (FormB document in selected)
                    {
	    ...
	    private void changeDocumentReadingStatus(bool status)
	    {
            try
            {
                ...
                {
                    FormB p = (FormB)Document_gridView.GetRow(i);
